    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md">
                ...
                <button type="submit"
                        className="w-full bg-indigo-600 text-white rounded-md py-2 px-4 hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700">Sign
                    Up
                </button>
            </form>
            <div className="mt-4 text-sm">
                <span>Already have an account? <a href="/"
                                                  className="text-indigo-600 hover:text-indigo-700">Login</a></span>
            </div>
        </div>
    );
};
